...
public class UserAccountController {
	...
	public String editProfile(ModelMap model, HttpSession session,
		...
		if (profileBean.getAvatar().isEmpty()) {
			...
			File file = new File(accountDir.getPath()+ File.separator + account.getAvatar());
			if (file.exists())
				file.delete();

			String avatarPath = accountDir.getPath() + File.separator + profileBean.getAvatar().getOriginalFilename();
